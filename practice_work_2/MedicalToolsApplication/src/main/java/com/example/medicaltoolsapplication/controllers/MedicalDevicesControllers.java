...
public class MedicalDevicesControllers {
    ...
    public MedicalDevices getMedicalDevices(@PathVariable("id") int id,
        ...
        MedicalDevices medicalDevices = service.findById(id);
        medicalDevices.add(
    ...
    @PostMapping
    public ResponseEntity<String> createMedicalDevices(@RequestBody MedicalDevices medicalDevices,
                                               @RequestHeader(value = "Accept-Language", required = false) Locale locale){
        return ok(service.createMedicalDevices(medicalDevices, locale));
    }

    @PutMapping("/{id}")
    public ResponseEntity<String> updateMedicalDevices(@PathVariable("id") int id,
